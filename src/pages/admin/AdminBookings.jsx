...
const BOOKINGS = [
  ...
  { id:2, ref:'HO-2XR7T', guest:'Esi Boateng', email:'esi@example.com', checkIn:'2026-09-06', checkOut:'2026-09-08', nights:2, guests:1, total:960, status:'confirmed' },
  { id:3, ref:'HO-K3P9M', guest:'Nana Adjei', email:'nana@example.com', checkIn:'2026-09-15', checkOut:'2026-09-19', nights:4, guests:3, total:2480, status:'pending' },
  { id:4, ref:'HO-YB4LN', guest:'Abena Mensah', email:'abena@example.com', checkIn:'2026-07-10', checkOut:'2026-07-17', nights:7, guests:2, total:3360, status:'completed' },
];
